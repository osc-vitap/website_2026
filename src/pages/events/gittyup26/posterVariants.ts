...
export const posterVariants: PosterVariant[] = [
	...
	},
	{
		...
		"layers": [
			...
			"linear-gradient(#ffffff,#ffffff) 0 16%/100% 4px no-repeat",
			"linear-gradient(rgba(255,255,255,.45),rgba(255,255,255,.45)) 0 76%/100% 2px no-repeat"
		],
		"ink": "#ffffff",
	...
	},
	{
		...
		"emphasis": "your room",
		"dateLine": "29 Aug 2026 / 10am to 5pm · AB-2",
		"venueLine": "AB-2"
	},
	{
		"id": 6,
		...
		"emphasis": "command",
		"dateLine": "29 August 2026 / 10am to 5pm · AB-2 Auditorium",
		"venueLine": "AB-2 Auditorium"
	},
	{
		"id": 7,
	...
	},
	{
		...
		"accent": "rgba(86,0,255,.4)",
		"rows": 2,
		"eyebrow": "gitty up · 2026",
	...
	},
	{
		...
		"layers": [
			...
			"linear-gradient(64deg,rgba(0,0,0,0) 40%,rgba(230,235,243,.55) 51%,rgba(255,240,250,.42) 55%,rgba(58,62,70,.7) 59%,rgba(196,203,214,.45) 65%,rgba(0,0,0,0) 79%)",
			"radial-gradient(56% 40% at 78% 38%,rgba(0,0,0,0) 0%,rgba(0,0,0,.4) 58%,rgba(0,0,0,.96) 88%)",
			"linear-gradient(90deg,#000 0%,rgba(0,0,0,.94) 60%,rgba(0,0,0,0) 100%)",
			"linear-gradient(180deg,rgba(0,0,0,0) 0%,rgba(0,0,0,.88) 38%,#000 72%)"
		],
	...
	},
	{
		...
		"accent": "#6a12ff",
		"rows": 5,
		"eyebrow": "Some of our events that you might recognise",
